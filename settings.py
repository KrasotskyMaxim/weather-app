...
CITY_FORECAST_URL="{domain}/data/2.5/forecast/daily?q={city}&units={units}&cnt={cnt}&lang={lang}&appid={key}"
GEO_FORECAST_URL="{domain}/data/2.5/forecast/daily?lat={lat}&lon={lon}&units={units}&cnt={cnt}&lang={lang}&appid={key}"
